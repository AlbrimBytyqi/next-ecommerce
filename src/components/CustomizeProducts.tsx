  ...
  return (
    <div className=" flex flex-col gap-6">
      {productOptions.map((option) => (
        <div className=" felx flex-col gap-4" key={option.name}>
          ...
          <ul className=" flex items-center gap-3">
            {option.choices?.map((choice) => {
              ...
              return option.name === "Colore" ? (
                <li
                  className=" mt-2 w-8 h-8 rounded-full ring-1 ring-gray-300 relative"
                  style={{
                ...
                <li
                  className=" mt-2 ring-1 ring-lama text-lama rounded-md py-1 px-4 text-sm"
                  style={{
                    cursor: disabled ? "not-allowed" : "pointer",
